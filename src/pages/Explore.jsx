...
const Explore = () => {
    // Styling Variables (USE THIS FORMAT: Permanent Styling [like font fam] then responsive styles starting from smallest size
        ...
        const main_page_desc_cont = "absolute inset-0 left-0 bg-cards_overlay/80 opacity-0 flex flex-col items-center justify-center gap-[40px] group-hover:opacity-100 transition-opacity duration-800 ease-in-out hover:cursor-pointer hover:cursor-pointer";
    ...
    const explore_menu = {
        Attractions: [
            { id: 1, name: "Coves", src: "/lascalas_assets/Website/MainPages_Content/Explore/Attractions/Attractions1.webp", description: "Discover the edge of paradise. Explore the hidden beaches and tranquil inlets of Las Calas Coves. Enclosed by majestic cliffs, it is the ultimate setting for private escapes and nature’s purest serenity.", link: "#" },
            { id: 2, name: "Gazebo", src: "/lascalas_assets/Website/MainPages_Content/Explore/Attractions/Attractions2.webp", description: "Unwind in style. The Las Calas Gazebo offers a haven of peace surrounded by nature’s beauty. With the gentle sound of the waves as your soundtrack, it’s the perfect spot for romance, luxury, and unforgettable sunsets.", link: "#" },
            { id: 3, name: "Lucky Park", src: "/lascalas_assets/Website/MainPages_Content/Explore/Attractions/Attractions3.webp", description: "Walk on the bright side. Step into Lucky Park, a whimsical garden designed to inspire joy and prosperity. From vibrant wishing ribbons to playful lucky charms, every corner radiates positive energy and a touch of magic.", link: "#" },
            { id: 4, name: "Mango Tree", src: "/lascalas_assets/Website/MainPages_Content/Explore/Attractions/Attractions4.webp", description: "Rooted in magic. Experience the quiet power of the Millennium Mango Tree. This ancient wonder offers a unique blend of nature and luxury, a perfect, opulent spot to pause and embrace the soul of Las Calas.", link: "#" },
            { id: 5, name: "Pearl Collections", src: "/lascalas_assets/Website/MainPages_Content/Explore/Attractions/Attractions5.webp", description: "Treasures of the deep. Explore the Las Calas Pearl Collection, an exclusive showcase of rare, elegant gems that perfectly reflect the timeless beauty of the sea.", link: "#" },
            { id: 6, name: "Swing", src: "/lascalas_assets/Website/MainPages_Content/Explore/Attractions/Attractions6.webp", description: "Swing into paradise. Hover above crystal-clear shallows on our iconic overwater swing. With the ocean breeze in your hair and endless blue horizons, it’s the ultimate spot for romance and unforgettable photos.", link: "#" },
            { id: 7, name: "Wishing Well", src: "/lascalas_assets/Website/MainPages_Content/Explore/Attractions/Attractions7.webp", description: "A sanctuary for your dreams. Hidden within our lush greenery, the Wishing Well offers a moment of pure serenity. Embrace the magic of the moment in this elegant setting, where every wish feels a little closer to coming true.", link: "#" },
        ],
        Activities: [
            { id: 1, name: "ATV Adventure", src: "/lascalas_assets/Website/MainPages_Content/Explore/Activities/Activities1.webp", description: "Ready to ride? Ignite your spirit of adventure and go off the beaten path! Whether you're chasing an adrenaline rush or just chasing views, our ATV tour is the ultimate way to experience the wild beauty of Las Calas.", link: "/exploreATV" },
            { id: 2, name: "Water Adventure", src: "/lascalas_assets/Website/MainPages_Content/Explore/Activities/Activities2.webp", description: "Dive into adventure with the LasCalas Jetski and Kayak Ride Experience, where the thrill of the open water meets the beauty of nature.", link: "/exploreWater" },
            { id: 3, name: "Buggy And Polaris Ride", src: "/lascalas_assets/Website/MainPages_Content/Explore/Activities/Activities3.webp", description: "Buckle up for the ultimate joyride! Gather your squad and tear up the trails in our heavy-duty Buggies and Polaris RZRs. It’s loud, it’s muddy, and it’s the most fun you’ll have on four wheels.", link: "/exploreBug" },
            { id: 4, name: "Rope Course & Obstacle Course", src: "/lascalas_assets/Website/MainPages_Content/Explore/Activities/Activities4.webp", description: "Do you have what it takes? Designed by the Special Forces of the Philippines, our authentic Rope and Obstacle Course tests your strength and teamwork in the heart of nature. Step up and conquer the challenge!", link: "/exploreRope" },
        ],
        Experiences: [
            ...
            <div className={`${center_element_col} gap-[40px]`}>
                <div className={`${center_element_row} justify-center w-full`}>
                    {Object.keys(explore_menu).map((category) => {
                        const tab_styling = `font-Montserrat text-explore_label transition-all duration-300 w-full text-[40px] resSm:text-[16px] resSm:p-4 resMd:text-[24px] resMd:p-6 resLg:text-[32px] resLg:p-6 ${activeTab === category ? "text-background_lightTxt bg-highlight font-bold text-explore_tab_active" : "bg-secondary/60 text-background_lightTxt font-[500] text-explore_tab_inactive"}`;

...
const PackageDetails = () => {
    ...
    },
    {
        ...
        preview_images: Array.from({ length: 6 }, (_, i) => 
            `/lascalas_assets/Website/MainPages_Content/Packages/PackagePreview/Executive_2/EX${i + 1}.webp`
        ),
    },
    {
        id: 3,
    ...
    // -- STYLING -- //
    const package_details_cont = "grid grid-cols-2 gap-8 justify-between w-full px-[200px] mt-[40px] resSm:flex resSm:flex-col resSm:items-center resSm:border";
        ...
        >
            ...
            <div className={`${center_element_col} justify-center`}>
                ...
                <div className={`${package_details_cont}`}>
                    <div className={`w-full max-w-[400px] resSm:w-[360px] `}>
                    ...
                    <div className="w-full max-w-[400px] resMd:w-[600px] resSm:w-[360px] resSm:h-[280px]">
                        <Swiper
                            grabCursor={true}
                            centeredSlides={true}
                            slidesPerView={1}
                            ...
                            className="w-[600px] pb-[40px] resSm:w-[360px] resSm:h-[300px] resMd:w-[540px]"
                            navigation
                            autoplay={{
                                delay: 3000,

...
const CampingGround = () => {
    ...
    const camp_grid_cont = "grid grid-cols-2 gap-12 items-center w-full max-w-6xl px-6 my-[80px] resSm:flex resSm:flex-col";
    const campCard_grid_cont = "grid grid-cols-2 gap-[8px] items-stretch";
    const camp_tagline = "font-Raleway font-bold text-main_text/60 tracking-tight uppercase text-[32px] resSm:text-[20px] resMd:text-[26px]";
...
const CampingCard = ({ camp }) => {
    ...
    const campCard_name = "font-Nunito font-[600] text-background_lightTxt text-[18px] resSm:text-[14px] resSm:text-center";

...
const GamingPool = () => {
    ...
    const gamPool_grid_cont = "grid grid-cols-2 gap-12 items-center w-full max-w-6xl px-6 my-[80px] resSm:flex resSm:flex-col";
    const gamPoolCard_grid_cont = "grid grid-cols-2 gap-[8px] items-stretch";
    const gamPool_tagline = "font-Raleway font-bold text-main_text/60 tracking-tight uppercase text-[32px] resSm:text-[20px] resMd:text-[26px]";
    ...
    return (
        ...
        >
            ...
            <div className={`${center_element_col} justify-center resSm:mt-[40px] resMd:mt-[60px]`}>
                <h1 className={`${space_name}`}>Gaming Villa & Infinity Pool</h1>
                <h2 className={`${space_price}`}>Starting at PHP 15,000 for exclusive use</h2>
...
const GamingPoolCard = ({ gamPool }) => {
    ...
    const gamPoolCard_name = "font-Nunito font-[600] text-background_lightTxt text-[18px] resSm:text-[14px] resSm:text-center";
